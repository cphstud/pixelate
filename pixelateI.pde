...
void setup() {
  ...
  //File dir = new File(System.getProperty("user.home") + "/Documents/Processing/pixelateI/viktor");
  File dir = new File(System.getProperty("user.home") + "/Documents/Dokumenter – 10.15.3 (8)/Processing/pixelateI/data");
